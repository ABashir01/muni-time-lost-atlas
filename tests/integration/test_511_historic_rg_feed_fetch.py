"""Controlled integration checks for historic 511 regional GTFS acquisition."""
...
class HistoricRgGtfsFetchIntegrationTests(unittest.TestCase):
    def test_live_511_historic_rg_fetch_if_token_is_configured(self) -> None:
        try:
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            self.assertEqual(metadata["operator_id"], "RG")
